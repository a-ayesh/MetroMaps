    ...
    <footer className="bg-light text-center text-lg-start text-muted mt-5">
        ...
        <Container className="text-center text-md-start mt-5">
          <Row className="mt-3">
            <Col md="3" lg="4" xl="3" className="mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">MetroMaps</h6>
              <p>An open-source work-in-progress.</p>
            </Col>
            ...
            <Col md="4" lg="3" xl="3" className="mx-auto mb-md-0 mb-4">
              ...
              <p>
                ...
                . aahmad.bese21seecs@seecs.edu.pk
              </p>
              <p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        <a className="text-reset fw-bold" href="https://mdbootstrap.com/">
          https://github.com/a-ayesh/MetroMaps
        </a>
      </div>
    </footer>
  );
